...
const RegistrationCustomerForm: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const response = await axios.post(`${server}/create-customer`, formData, {
        headers: {
  ...
  return (
    <div className="">
      <div className="lg:w-[40%] md:w-[70%] w-[90%] mt-10 p-9 md:p-14 lg:p-10 border bg-[#fff] shadow-lg mx-auto mb-4">
        ...
        <div>
          <p className="text-center px-10 font-normal text-sm mt-4">
